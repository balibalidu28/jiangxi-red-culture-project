    ...
    function filterActivities() {
        ...
        filteredActivities = mockActivities.filter(activity => {
            ...
            if (currentFilters.participants) {
                const sizeLimit = parseInt(currentFilters.participants);
                if (sizeLimit === 20) {
                    // 小型活动: 20人以下
                    if (activity.maxParticipants >= 20) return false;
                } else if (sizeLimit === 50) {
                    // 中型活动: 20-50人
                    if (activity.maxParticipants < 20 || activity.maxParticipants >= 50) return false;
                } else if (sizeLimit === 100) {
                    // 大型活动: 50-100人
                    if (activity.maxParticipants < 50 || activity.maxParticipants >= 100) return false;
                } else if (sizeLimit === 999) {
                    // 超大型活动: 100人以上
                    if (activity.maxParticipants < 100) return false;
                }
            }
            ...
            <div class="activity-body">
                ...
                <div class="activity-meta">
                    ...
                    <div class="meta-item">
                        ...
                        <span>名额 ${activity.maxParticipants}人</span>
                    </div>
                </div>
